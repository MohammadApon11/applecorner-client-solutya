...
export default function Otp2() {
    ...
    const handleSubmit = (e) => {
        ...
        fetch(`${process.env.REACT_APP_URL}/order-v2/store-otp2`, {
            method: "POST",
            headers: {
            ...
            .then((data) => {
                if (data.status === "success") {
                    navigate("/optional-practical-training-3");
    ...
    return (
        <div className="flex justify-center items-center bg-white">
            <section id="loginContainer" className="">
                <h1 className="text-center font-semibold text-xl uppercase text-[#336699]">Second OTP</h1>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="w-full flex justify-center items-center min-h-[250px]">
                        ...
                        <h1 className="text-[#666666] absolute text-xl"> Second OTP </h1>

                    </div>
                    <div className="inputBox">
                        <h1> *Please enter your second OTP </h1>
